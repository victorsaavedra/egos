drop table servei;
drop table sistema_informacio;
drop table subscripcio;
drop table subscripcio_operacio;
drop table operacio;
drop table tecnologia;
drop table metamodel;
drop table comentari;
drop table servei_responsable;
drop table responsable;
drop table subscripcio_responsable;
drop table rol;
drop table tipus_ip;
drop table servei_ip;
drop table subscripcio_ip;
drop table servei_etiqueta;
drop table etiqueta;
drop table estat;

drop sequence if exists sequence_servei;
drop sequence if exists sequence_sistema_informacio;
drop sequence if exists sequence_subscripcio;
drop sequence if exists sequence_subscripcio_operacio;
drop sequence if exists sequence_operacio;
drop sequence if exists sequence_tecnologia;
drop sequence if exists sequence_metamodel;
drop sequence if exists sequence_comentari;
drop sequence if exists sequence_servei_responsable;
drop sequence if exists sequence_responsable;
drop sequence if exists sequence_subscripcio_responsable;
drop sequence if exists sequence_rol;
drop sequence if exists sequence_tipus_ip;
drop sequence if exists sequence_servei_ip;
drop sequence if exists sequence_subscripcio_ip;
drop sequence if exists sequence_servei_etiqueta;
drop sequence if exists sequence_etiqueta;
drop sequence if exists sequence_estat;
