$(document).ready(function(){
	...
	$('#desarComentari').click(function() {
		var action = $('#comentarisForm').attr('action');
		$('#comentarisForm').attr('action', action);
		$('#comentarisForm').attr('method', "PUT");
		$('#comentarisForm').submit();
	});
