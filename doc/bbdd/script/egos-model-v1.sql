...
CREATE SEQUENCE SEQUENCE_SERVEI_TECNOLOGIA START 1 INCREMENT 1;
CREATE SEQUENCE SEQUENCE_TECNOLOGIA START 1 INCREMENT 1;
CREATE SEQUENCE SEQUENCE_SERVEI_METAMODEL START 1 INCREMENT 1;
...
CREATE TABLE servei_tecnologia (
	id_servei_tecnologia integer NOT NULL DEFAULT nextval('SEQUENCE_SERVEI_TECNOLOGIA'),
	id_servei integer NOT NULL,
	id_tecnologia integer NOT NULL
);
ALTER TABLE servei_tecnologia ADD CONSTRAINT PK_SERVEI_TECNOLOGIA PRIMARY KEY(id_servei_tecnologia);
...
CREATE TABLE servei_metamodel (
	id_servei_metamodel integer NOT NULL DEFAULT nextval('SEQUENCE_SERVEI_METAMODEL'),
	id_servei integer NOT NULL,
	id_metamodel integer NOT NULL
);
ALTER TABLE servei_metamodel ADD CONSTRAINT PK_SERVEI_METAMODEL PRIMARY KEY(id_servei_metamodel);
...
ALTER TABLE servei_ip ALTER COLUMN id_servei_ip SET DEFAULT nextval('sequence_servei_ip'::regclass);
...
ALTER TABLE servei_tecnologia ADD CONSTRAINT FK_SERVEI_TECNOLOGIA__SERVEI FOREIGN KEY (id_servei) REFERENCES servei(id_servei) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE servei_tecnologia ADD CONSTRAINT FK_SERVEI_TECNOLOGIA__TECNOLOGIA FOREIGN KEY (id_tecnologia) REFERENCES tecnologia(id_tecnologia) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE servei_metamodel ADD CONSTRAINT FK_SERVEI_METAMODEL__SERVEI FOREIGN KEY (id_servei) REFERENCES servei(id_servei) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE servei_metamodel ADD CONSTRAINT FK_SERVEI_METAMODEL__METAMODEL FOREIGN KEY (id_metamodel) REFERENCES metamodel(id_metamodel) ON DELETE CASCADE ON UPDATE CASCADE;
